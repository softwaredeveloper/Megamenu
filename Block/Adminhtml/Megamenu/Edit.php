...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    /**
     * Initialize megamenu edit block
     *
     * @return void
     */
    protected function _construct()
    {
        $this->_objectId = 'id_menu';
        $this->_blockGroup = 'Renouard_Megamenu';
        ...
        $this->buttonList->update('delete', 'label', __('Delete Megamenu'));
    }
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('megamenu')->getId()) {
            return __("Edit Megamenu '%1'", $this->escapeHtml($this->_coreRegistry->registry('megamenu')->getTitle()));
        } else {
            return __('New Megamenu');
        }
    }
